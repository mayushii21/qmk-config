...
#define ________________LEFT_HAND_SYMBOLS_ROW_1________________ _______, DDSLASH, KC_RABK, KC_LABK, KC_SLSH, KC_PERC, KC_DLR
...
#define ________________LEFT_HAND_SYMBOLS_ROW_3________________ _______, KC_DQUO, KC_BSLS,  KC_GRV, KC_ASTR, KC_CIRC, KC_AT
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+---------+---------+---------+--------|                    |--------+--------+---------+--------+--------+--------|
      XXXXXXX,    KC_X,     KC_Q,     KC_M,     KC_W,    KC_Z,                         KC_K,    KC_F,  KC_QUOT, KC_SCLN,  KC_DOT, XXXXXXX,
  //|--------+--------+---------+---------+---------+--------+--------|  |--------+--------+--------+---------+--------+--------+--------|
 ...
 TD(TD_RESET), MS_WHLU, MS_BTN2,   MS_UP, MS_BTN1,TO(GAMING),                      KC_HOME, KC_PGDN, KC_PGUP,  KC_END, XXXXXXX, _______,
  ...
  //|--------+--------|-------+--------+--------+--------+                    |--------+--------+--------+--------+--------+--------|
       KC_TAB,    KC_G,   KC_A,    KC_S,    KC_D,    KC_F,                         KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_RALT,
  //|--------+--------|-------+--------+--------+--------+                    |--------+--------+--------+--------+--------+--------|
      XXXXXXX,    KC_B,   KC_Z,    KC_X,    KC_C,    KC_V,                         KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,TO(BASE),
  //|--------+--------+-------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          KC_LGUI, KC_LSFT,  KC_SPC,     KC_ENT, XXXXXXX, XXXXXXX
                                      //`--------------------------'  `--------------------------'
  )
};
